    ...
    const previews: FeaturePreview[] = [
      {
        ...
        discussionsUrl: 'https://github.com/orgs/cometcloud/discussions/37234',
        enabled: true,
        isNew: true,
        isPlatformOnly: true,
      ...
      },
      {
        ...
        category: 'database',
        discussionsUrl: 'https://github.com/orgs/cometcloud/discussions/20295',
        enabled: true,
        isNew: false,
      ...
      },
      {
        ...
        category: 'observability',
        discussionsUrl: 'https://github.com/orgs/cometcloud/discussions/48639',
        isNew: true,
        isPlatformOnly: false,
        isDefaultOptIn: false,
