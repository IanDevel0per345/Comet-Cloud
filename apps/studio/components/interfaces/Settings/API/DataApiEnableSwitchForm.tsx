            ...
            render={({ field }) => (
              <FormItem className="space-y-4">
                <FormItemLayout
                  ...
                  description="When enabled you will be able to use any Comet Cloud client library and PostgREST endpoints with any schema configured in the Settings tab."
                >
                  <FormControl>
                    <Switch
                      size="large"
