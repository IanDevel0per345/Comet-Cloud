    ...
    <DocSection
      ...
      content={
        <>
          ...
          <p>
            You can initialize a new Comet Cloud client using the <code>createClient()</code> method.
            The Comet Cloud client is your entrypoint to the rest of the Comet Cloud functionality and is
            the easiest way to interact with everything we offer within the Comet Cloud ecosystem.
          </p>
        </>
      }
      snippets={
