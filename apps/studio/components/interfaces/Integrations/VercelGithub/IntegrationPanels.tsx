...
type HandleIconType = Integration['integration']['name'] | 'Comet Cloud'
...
const HandleIcon = ({ type, className }: { type: HandleIconType; className?: string }) => {
  switch (type) {
    ...
    case 'Vercel':
      ...
      break
    case 'Comet Cloud':
      return <img src={`${BASE_PATH}/img/comet-logo.svg`} alt="Comet Cloud" className="w-3.5"></img>
      break
